...
class StaffMember:
    ...
    def __init__(self, name, availability, cum_wdays, cum_wends, cum_sitter):
        ...
        self.scheduled_sitter = cum_sitter      # count for number of sitter roles a staff member is scheduled in a month
